...
kitty_themes_DiR="/etc/nixos/apps/kitty/kitty-themes" # Kitty Themes Directory
kitty_config="/etc/nixos/apps/kitty/kitty.conf"
iDIR="/etc/nixos/apps/swaync/images" # For notifications
rofi_theme_for_this_script="/etc/nixos/apps/rofi/config-kitty-theme.rasi"
