...
keybinds_conf="/etc/nixos/apps/hypr/configs/Keybinds.conf"
user_keybinds_conf="/etc/nixos/apps/hypr/UserConfigs/UserKeybinds.conf"
laptop_conf="/etc/nixos/apps/hypr/UserConfigs/Laptops.conf"
rofi_theme="/etc/nixos/apps/rofi/config-keybinds.rasi"
