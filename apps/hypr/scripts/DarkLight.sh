...
# Paths
wallpaper_base_path="/etc/nixos/apps/wallpapers/Dynamic-Wallpapers"
dark_wallpapers="$wallpaper_base_path/Dark"
light_wallpapers="$wallpaper_base_path/Light"
hypr_config_path="/etc/nixos/apps/hypr"
swaync_style="/etc/nixos/apps/swaync/style.css"
ags_style="/etc/nixos/apps/ags/user/style.css"
SCRIPTSDIR="/etc/nixos/apps/hypr/scripts"
notif="/etc/nixos/apps/swaync/images/bell.png"
wallust_rofi="/etc/nixos/apps/wallust/templates/colors-rofi.rasi"

kitty_conf="/etc/nixos/apps/kitty/kitty.conf"

wallust_config="/etc/nixos/apps/wallust/wallust.toml"
pallete_dark="dark16"
...
set_waybar_style() {
    theme="$1"
    waybar_styles="/etc/nixos/apps/waybar/style"
    waybar_style_link="/etc/nixos/apps/waybar/style.css"
...
if [ "$next_mode" = "Dark" ]; then
    ...
    #qt5ct_color_scheme="/etc/nixos/apps/qt5ct/colors/Catppuccin-Mocha.conf"
    #qt6ct_color_scheme="/etc/nixos/apps/qt6ct/colors/Catppuccin-Mocha.conf"
else
    kvantum_theme="catppuccin-latte-blue"
    #qt5ct_color_scheme="/etc/nixos/apps/qt5ct/colors/Catppuccin-Latte.conf"
    #qt6ct_color_scheme="/etc/nixos/apps/qt6ct/colors/Catppuccin-Latte.conf"
fi

sed -i "s|^color_scheme_path=.*$|color_scheme_path=$qt5ct_color_scheme|" "/etc/nixos/apps/qt5ct/qt5ct.conf"
sed -i "s|^color_scheme_path=.*$|color_scheme_path=$qt6ct_color_scheme|" "/etc/nixos/apps/qt6ct/qt6ct.conf"
...
set_custom_gtk_theme() {
    ...
    if [ ${#icons[@]} -gt 0 ]; then
        ...
        ## QT5ct icon_theme
        sed -i "s|^icon_theme=.*$|icon_theme=$selected_icon|" "/etc/nixos/apps/qt5ct/qt5ct.conf"
        sed -i "s|^icon_theme=.*$|icon_theme=$selected_icon|" "/etc/nixos/apps/qt6ct/qt6ct.conf"
