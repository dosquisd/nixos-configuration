...
# --- Configuration ---
ROFI_THEMES_DIR_CONFIG="/etc/nixos/apps/rofi/themes"
ROFI_THEMES_DIR_LOCAL="$HOME/.local/share/rofi/themes"
ROFI_CONFIG_FILE="/etc/nixos/apps/rofi/config.rasi"
ROFI_THEME_FOR_THIS_SCRIPT="/etc/nixos/apps/rofi/config-rofi-theme.rasi" # A separate rofi theme for the picker itself
IDIR="/etc/nixos/apps/swaync/images"                                     # For notifications
