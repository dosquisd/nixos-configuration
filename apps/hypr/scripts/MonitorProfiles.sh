...
monitor_dir="/etc/nixos/apps/hypr/Monitor_Profiles"
target="/etc/nixos/apps/hypr/monitors.conf"
rofi_theme="/etc/nixos/apps/rofi/config-Monitors.rasi"
msg='❗NOTE:❗ This will overwrite /etc/nixos/apps/hypr/monitors.conf'
