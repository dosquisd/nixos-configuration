...
find_themes() {
    directories=("$HOME/.local/share/rofi/themes" "/etc/nixos/apps/rofi/themes")
...
add_theme_to_config() {
    ...
    elif [[ -f "/etc/nixos/apps/rofi/themes/$theme_name.rasi" ]]; then
        theme_path="/etc/nixos/apps/rofi/themes/$theme_name.rasi"
    else
